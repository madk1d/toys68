...
<meta name="description" content="Каталог игрушек ручной работы из мягкой плюшевой пряжи высокого качества. Готовые варианты дизайна. 100% handmade." />
...
<link rel="canonical" href="http://toys68.ru/toys/"/>
...
<title>Мастерская TOYS68 | Каталог игрушек</title>
	...
	?>
					...
					<nav id="menu">
						...
						<ul>
							...
							<li><a href="#"><i class="fa fa-list" aria-hidden="true"></i>&nbsp;&nbsp;Каталог игрушек</a></li>
					...
					<div id="main">
						<div class="inner">
							...
							<p>Здесь представлены категории игрушек ручной работы.<br>
							Выбрав нужную категорию, вы можете ознакомиться с готовыми вариантами дизайна и ценами, а так же оформить заказ. Не нашли, что искали, но у вас есть свои идеи дизайна?  Посетите раздел <a href="/toys/spec/">Ваш дизайн</a>.
							</p>
							<div class="box alt">
										<div class="row gtr-uniform">
			<?php
			
			$query = "SELECT DISTINCT picf,type FROM toys ";
			 ...
			 echo '<div class="'.$div_class.'"><span class="image fit" style="text-align:center"><a href="/toys/'.$row['picf'].'/"><img src="/images/'.$row['picf'].'.jpg" alt="'.$row['type'].'" /></a><a href="/toys/'.$row['picf'].'/">'.$row['type'].'</a></span></div>';
			 echo "\n";
												}
			 
												}
												echo '<div class="'.$div_class.'"><span class="image fit" style="text-align:center"><a href="/toys/spec/"><img src="/images/spec_big.jpg" alt="Дизайн" /></a><a href="/toys/spec/">Ваш дизайн</a></span></div>';
